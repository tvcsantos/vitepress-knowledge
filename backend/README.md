...
| `PORT`                 | `5174`                  | Public port: chat UI, chat API, model list, static assets. Expose this to the internet. (The Docker image defaults this to `3000`.)                             |
| `MANAGEMENT_PORT`      | `5175`                  | Management port: site CRUD, knowledge upload, health check. Keep this internal — do not expose it to the internet.                                              |
